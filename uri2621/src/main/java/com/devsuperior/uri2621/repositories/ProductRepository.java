...
public interface ProductRepository extends JpaRepository<Product, Long> {
	...
	List<ProductMinProjection> searchBySQL(Integer min,Integer max,String beginName);
	...
	List<ProductMinDTO> searchByJPQL(Integer min,Integer max,String beginName);
